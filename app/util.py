...
def error_handling(r):
    if r.status_code == 200:
        ...
        data = get_5_latest_songs(access_token)
        return render_template('dashboard.html', track0_Name=data[0], \
            song_uri_0=data[1], track1_Name=data[2], song_uri_1=data[3], \
                track2_Name=data[4], song_uri_2=data[5], track3_Name=data[6], \
                    song_uri_3=data[7], track4_Name=data[8], song_uri_4=data[9], \
                        tday=data[10])
